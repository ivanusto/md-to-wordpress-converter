...
- 🛡️ **AI Invisible Watermarks & Fingerprint Auto-Cleaner (AI 隱形浮水印自動清除)**: Automatically strips zero-width spaces (U+200B/C/D), tag characters, bidi overrides, and variation selectors generated by ChatGPT, Claude, and Gemini during `.md` file import or live conversion.
