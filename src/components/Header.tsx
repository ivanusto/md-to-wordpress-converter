      ...
      <div className="header-controls">
        <div className="header-external-links">
          ...
          >
            ...
            <span>{t('header.github', lang)}</span>
          </a>
        </div>
        ...
        <div className="action-buttons-group">
          ...
          >
            ...
            <span>{t('header.loadSample', lang)}</span>
          </button>
          ...
          >
            ...
            <span>{t('header.import', lang)}</span>
          </button>
          ...
          {hasContent && (
            <>
              ...
              >
                ...
                <span>{t('header.download', lang)}</span>
              </button>
