...
export const I18N_STRINGS = {
  'zh-TW': {
    ...
    'imgclean.title': '上傳前清除圖片與影音中繼資料',
    'imgclean.desc': '在你的瀏覽器本機移除 C2PA、EXIF、XMP、ID3 與 AI 標記。像素、取樣與波形完全不動，也不重新壓縮；影片只讀取標頭，不會整個載入記憶體',
    'imgclean.drop': '拖放圖片、音訊或影片到此，或點選選擇檔案',
    'imgclean.formats': '支援 PNG、JPEG、WebP、AVIF、HEIC、GIF 與 MP4、MOV、M4A、M4V、MP3、WAV、FLAC',
    'imgclean.removed': '已移除 {n} 個中繼資料區塊',
    'imgclean.alreadyClean': '原本就沒有可移除的中繼資料',
    'imgclean.download': '下載清除後的檔案',
    'imgclean.clearAll': '清空清單',
    'imgclean.unsupported': '不支援的格式（僅支援 PNG、JPEG、WebP、AVIF、HEIC、GIF、MP4、MOV、M4A、M4V、MP3、WAV、FLAC）',
    'imgclean.truncated': '這個檔案在 box 中途就結束了。尾段已原樣保留，但無法檢查，因此不能算是乾淨。',
    'imgclean.toastCleaned': '🛡️ 已處理 {files} 個檔案，移除 {n} 個中繼資料區塊！',
    'imgclean.toastAlreadyClean': '🛡️ 已檢查 {files} 個檔案，沒有發現需要移除的中繼資料',
    ...
    'settings.stripPrivateUse': '清除私有使用區 (PUA) 字元',
    'settings.stripPrivateUseDesc': '預設保留。PUA 是圖示字型 (Font Awesome 等) 存放圖示的區段，誤刪會讓文章圖示消失；但它同時也可能被用來夾帶標記，需要時再開啟',
  ...
  'en': {
    ...
    'imgclean.title': 'Strip image, audio and video metadata before uploading',
    'imgclean.desc': 'Removes C2PA, EXIF, XMP, ID3 and AI marks locally in your browser. Pixels, samples and waveforms are untouched and nothing is recompressed; video is read through its headers rather than loaded into memory',
    'imgclean.drop': 'Drop images, audio or video here, or click to choose files',
    'imgclean.formats': 'Supports PNG, JPEG, WebP, AVIF, HEIC, GIF and MP4, MOV, M4A, M4V, MP3, WAV, FLAC',
    'imgclean.removed': 'Removed {n} metadata block(s)',
    'imgclean.alreadyClean': 'No metadata to remove',
    'imgclean.download': 'Download cleaned file',
    'imgclean.clearAll': 'Clear list',
    'imgclean.unsupported': 'Unsupported format (PNG, JPEG, WebP, AVIF, HEIC, GIF, MP4, MOV, M4A, M4V, MP3, WAV and FLAC only)',
    'imgclean.truncated': 'This file ends mid-box. The tail was preserved byte for byte, but it could not be inspected, so the result cannot be called clean.',
    'imgclean.toastCleaned': '🛡️ Processed {files} file(s), removed {n} metadata block(s)!',
    'imgclean.toastAlreadyClean': '🛡️ Checked {files} file(s), no metadata needed removing',
    ...
    'settings.stripPrivateUse': 'Strip private-use area (PUA) characters',
    'settings.stripPrivateUseDesc': 'Kept by default. Icon fonts such as Font Awesome address their glyphs through this area, so stripping it makes icons vanish from a post — but it can also carry marks, so enable it when you need to',
