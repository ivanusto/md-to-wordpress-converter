...
export const I18N_STRINGS = {
  'zh-TW': {
    ...
    'imgclean.title': '上傳前清除圖片中繼資料',
    'imgclean.desc': '在你的瀏覽器本機移除 C2PA、EXIF、XMP 與 AI 標記。像素完全不動、不重新壓縮，畫質不受影響',
    'imgclean.drop': '拖放圖片到此，或點選選擇檔案',
    'imgclean.formats': '支援 PNG、JPEG、WebP、AVIF、HEIC',
    'imgclean.removed': '已移除 {n} 個中繼資料區塊',
    'imgclean.alreadyClean': '原本就沒有可移除的中繼資料',
    'imgclean.download': '下載清除後的圖片',
    'imgclean.clearAll': '清空清單',
    'imgclean.unsupported': '不支援的圖片格式（僅支援 PNG、JPEG、WebP、AVIF、HEIC）',
    'imgclean.toastCleaned': '🛡️ 已處理 {files} 張圖片，移除 {n} 個中繼資料區塊！',
    'imgclean.toastAlreadyClean': '🛡️ 已檢查 {files} 張圖片，沒有發現需要移除的中繼資料',
  ...
  'en': {
    ...
    'imgclean.title': 'Strip image metadata before uploading',
    'imgclean.desc': 'Removes C2PA, EXIF, XMP and AI marks locally in your browser. Pixels are untouched and nothing is recompressed, so image quality is unaffected',
    'imgclean.drop': 'Drop images here, or click to choose files',
    'imgclean.formats': 'Supports PNG, JPEG, WebP, AVIF, HEIC',
    'imgclean.removed': 'Removed {n} metadata block(s)',
    'imgclean.alreadyClean': 'No metadata to remove',
    'imgclean.download': 'Download cleaned image',
    'imgclean.clearAll': 'Clear list',
    'imgclean.unsupported': 'Unsupported image format (PNG, JPEG, WebP, AVIF and HEIC only)',
    'imgclean.toastCleaned': '🛡️ Processed {files} image(s), removed {n} metadata block(s)!',
    'imgclean.toastAlreadyClean': '🛡️ Checked {files} image(s), no metadata needed removing',
