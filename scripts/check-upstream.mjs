 ...
 *
 * The ports in src/utils/ are hand-written copies of code that lives in other
 * repositories, so nothing in this repository notices when that code changes —
 * which is exactly how the Layer A port silently fell out of sync once. This
 * script is the tripwire.
 *
